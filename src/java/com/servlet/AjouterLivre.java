...
public class AjouterLivre extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        /*try{*/
            Livre liv = new Livre() ;
           // liv.AjouterLivre(0, titre, auteur, dateNai, genre,Integer.parseInt(categorie), Integer.parseInt(qt),"img");
           liv.insert(0, titre, auteur, dateNai, genre, Integer.parseInt(qt), categorie, photo, request, response);
        // request.setAttribute("res1",  "ajout succe");
      /*  }
        catch(Exception e){
                 request.setAttribute("res1",  "erreur");
            }*/
     // response.sendRedirect("lkjhgf");
        this.getServletContext().getRequestDispatcher("/AjouterLivre.jsp").forward(request, response);
