 ...
 * @author Maha
 */
public class MaReservation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MaReservation</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MaReservation at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Reservation rs=res.maReservation(nom.getMatricule());
        Livre l=new Livre();
        These t=new These();
        ...
        this.getServletContext().getRequestDispatcher( "/Reservtion.jsp" ).forward( request, response );
    }
