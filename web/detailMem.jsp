<%-- 
    Document   : detailMem
    Created on : 5 déc. 2017, 19:54:28
    Author     : Maha
--%>
...
<!--BANNER START-->
    ...
    <!--BANNER END-->
                ...
                <div class="col-md-9">
                    ...
                    <!--BOOK DETAIL START-->
                    <form action="getMemoire" method="post" enctype="multipart/form-data">
                    <div class="lib-book-detail">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="kode-thumb">
                                    <img src="image/${memoire.img}" alt="">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="kode-text">
                                	<h2>le Sujet de These : </h2>
                                    <div class="product-review">
                                        
                                    </div>
                                    <div class="product-price">
                                        <h4>${ memoire.sujet }</h4>
                                        <p>Encadrant : <span class="color">${memoire.encadrePar }</span></p>
                                    </div>
                                    <div class="book-text">
                                    ...
                                    <div class="book-text">
                                        ...
                                        <p>faite par: ${memoire.faitePar }</p>
                                        <p>date Publication: ${memoire.quantite }</p>
                                        <p>Encadrant: ${memoire.encadrePar }</p>
                                    </div>
                                   <c:if test="${etud==null}"><a class="add-to-cart btn btn-danger" href="Loginetudiant"> login</a></c:if>
                                        <c:if test="${etud!=null}"><input type="submit" value="Ajouter au panier"  class="add-to-cart"></c:if>
                    ...
                    <div class="product-review-tabs">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="Description">
                                <p>${memoire.categorie }</p>
                                <p><input hidden="true" type="text" name="id" value="${memoire.idThese }"></p>
                            </div>
