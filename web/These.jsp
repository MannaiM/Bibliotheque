<%@include file="MenuEtud.jsp" %>
    ...
    <div class="kode-inner-banner">
    	<div class="kode-page-heading">
            ...
            <ol class="breadcrumb">
              <li><a href="#">Home</a></li>
              <li><a href="#">These Guide</a></li>
              <li class="active">These</li>
            </ol>
        </div>
        <div class="container">
        	<div class="banner-search">
            	<div class="row">
                    <form action="TheseR" method="post">
                	<div class="col-md-2">
                    	<h2>Search<br> Votre These</h2>
                    </div>
                    <div class="col-md-4">
    ...
    <!--BANNER END-->
    <!--CONTENT START-->
    <form action="ListeThese" method="post">
 ...
 <c:forEach var="these" items="${these}">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="kode-single-blog">
                        <figure>
                            <a href="getThese?id=${these.idThese}" ><img src="image/${these.img}" alt=""></a>
                        </figure>
                        <div class="kode-text">
                        	<div class="kode-date">
