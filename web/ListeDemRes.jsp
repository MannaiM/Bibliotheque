<%-- 
    Document   : ListeDemRes
    Created on : 4 déc. 2017, 02:53:25
    Author     : Maha
--%>
...
<html>
    ...
    <body>
        ...
        <form action="listDemRes" method="post"  class="form-horizontal form-label-left" >
        <h1>Hello World!</h1>
...
<td> <a href="acceptRes?id=${reserv.idReservation}" class="btn btn-success">Accepter</a>
