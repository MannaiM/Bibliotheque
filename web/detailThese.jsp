<%-- 
    Document   : detailThese
    Created on : 5 déc. 2017, 02:02:18
    Author     : Maha
--%>
...
<%@include file="MenuEtud.jsp" %>
    ...
    <!--BANNER END-->
                ...
                <div class="col-md-9">
                    ...
                    <!--BOOK DETAIL START-->
                    <form action="getThese" method="post" enctype="multipart/form-data">
                    <div class="lib-book-detail">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="kode-thumb">
                                    <img src="image/${these.img}" alt="">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="kode-text">
                                    ...
                                    <div class="product-price">
                                        <h4>${ these.sujet }</h4>
                                        <p>Encadrant : <span class="color">${these.encadrePar }</span></p>
                                    </div>
                                    <div class="book-text">
                                    ...
                                    <div class="book-text">
                                        ...
                                        <p>faite par: ${these.faitePar }</p>
                                        <p>date Publication: ${these.quantite }</p>
                                        <p>Encadrant: ${these.encadrePar }</p>
                                    </div>
                    ...
                    <div class="product-review-tabs">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="Description">
                                <p>${these.categorie }</p>
                                <p><input hidden="true" type="text" name="id" value="${these.idThese }"></p>
                            </div>
