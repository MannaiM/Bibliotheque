<%-- 
    ...
    Created on : 1 déc. 2017, 10:21:33
    Author     : Maha
--%>
...
<html>
    ...
    <body>
        <%@include file="menu.jsp" %>
         <form action="listerEtudiant" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">>
        <h1>Hello World!</h1>
         <table class="table table-bordered pos " >
                        ...
                        <th>Image </th>
                            ...
                            <td> <a href="ModifierEtudiant?id=${etudiant.matricule}" class="btn btn-success">Modifier</a>
